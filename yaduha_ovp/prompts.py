...
SENTENCE_STRUCTURE_PROMPT = (
    ...
    "\n"
    "## Subject Forms\n"
    "A subject is either a pronoun, a noun with a proximity suffix, or a\n"
    "nominalized verb (agentive, 'the one who ___'):\n"
    "- Pronoun subject: use the subject pronoun directly\n"
    "- Noun subject: [noun]-[subject suffix]\n"
    "- Nominalized-verb subject: [verb stem]-[nominalizer]-[subject suffix]\n"
    "  - Subject suffix: Proximal (this/these): -ii, Distal (that/those): -uu\n"
    "  - Nominalizer: -dü (present, 'the one who runs'), -weidü (future, 'the one who will run')\n"
    "  Example: poyoha-dü-ii 'the one who runs (proximal)'\n"
    "           sawa-weidü-uu 'the one who will cook (distal)'\n"
    "\n"
    ...
    "Nominalized-verb objects fuse the nominalizer with the object suffix (the\n"
    "nominalizer vowel drops before the vowel-initial object suffix):\n"
    "- -dü + -neika/-noka → -deika/-doka  (e.g. poyoha-doka 'the one who runs', as object)\n"
    "- -weidü + -neika/-noka → -weideika/-weidoka\n"
    "\n"
